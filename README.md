...
Burası müşavirlik desteği vermiyor. Bu bilgileri genel kültür aktarımı olarak değerlendirin ve lütfen karar vermeden önce mutlaka müşavire danışarak ilerleyin.
...
Şirket kurmak zor ve masraflı bir süreç gibi zannedilse de günümüzde bu süreç hem çok daha kolay, hem de ilk aşamada ciddi bir maliyetten kurtulabileceğiniz destek fırsatlarını barındırıyor. Yararlanabileceğiniz ve sizi önemli bir masraftan kurtaran iki desteğin detaylarını aşağıda görebilirsiniz. Yaş veya başka bir sebepten dolayı Genç Girişimci Desteği'nden yararlanamıyor olsanız bile ihracat istisnasından yararlanabilirsiniz.
...
* Varlık barışı ile ilgili şartlar ve son tarih sürekli değiştiği için lütfen müşavirine danış.
...
![Hangi şirket türü](Sirket-turu.png)
...
Sadece freelancer platformları üzerinden çalışacaksan e-dönüşüm destekli yazılım yeterli ama yanlış kesilen faturanın düzeltilmesi ve gelen fatura takibinin olmaması gibi problemleri de yanında getiriyor.

Eğer gelir kalemlerin daha çeşitli olacaksa ve Gelir/gider takibi yapabilmek istiyorsan bu sefer Paraşüt (1000 TL + KDV) veya Logo İş Başı (600 TL + KDV) gibi programları kullanmak gerekecek.
...
![Nasıl fatura kesmeli](Nasil-fatura-kesmeli.png)
...
![Nasıl fatura kesmeli](Nasil-fatura-kesmeli-2.png)
...
Yukarıdaki mesaj için Oğuz'a teşekkür ederim.

# Yurtdışına para gönderimi ve alımı süreci
Yurtdışına para gönderimi ve alımı şöyle oluyor. Eğer gönderen ve alan banka muhabir banka değilse.  
